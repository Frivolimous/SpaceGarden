...
function game_init(){
	...
	gameM.paralax=makeStarfield(JSConfig.GRID_SIZE*gameM.PARALAX_RATIO,Math.max(gameM.gameBounds.right*gameM.PARALAX_RATIO,stageBorders.right),Math.max(gameM.gameBounds.bot*gameM.PARALAX_RATIO,stageBorders.bot),0x999999);
	gameM.paralax2=makeStarfield(JSConfig.GRID_SIZE*gameM.PARALAX_RATIO*gameM.PARALAX_RATIO,Math.max(gameM.gameBounds.right*gameM.PARALAX_RATIO*gameM.PARALAX_RATIO,stageBorders.right),Math.max(gameM.gameBounds.bot*gameM.PARALAX_RATIO*gameM.PARALAX_RATIO,stageBorders.bot),0x666666,GameColors.BACKGROUND);
