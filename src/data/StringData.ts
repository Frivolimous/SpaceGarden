export const EnglishStringData = {
  ...
  TOOLTIP_biglab_TITLE: 'Wild Lab',
  TOOLTIP_biglab_DESC: 'Creates fewer Research Blobs than the standard lab, but way more fruits.',
  TOOLTIP_wall_TITLE: 'Wall',
  TOOLTIP_wall_DESC: 'Prevents Blobs from passing through.',
  TOOLTIP_amp_TITLE: 'Blob Amplifier',
